...
<xsl:variable name="targetMessageID" select="/root/request/*[local-name()]/hl7:id/@root"/>
<xsl:variable name="targetMessageExtension" select="/root/request/*[local-name()]/hl7:id/@extension"/>

<!-- xsi:schemaLocation="urn:hl7-org:v3 http://www.intersystems.com/healthshare/ihe/schema/HL7V3/NE2008/multicacheschemas/MCCI_IN000002UV01.xsd" -->
...
<xsl:copy-of select = "/root/request/*[local-name()]/hl7:sender/hl7:device/."/>
</hl7:receiver>
<hl7:sender typeCode="SND">
<xsl:copy-of select = "/root/request/*[local-name()]/hl7:receiver/hl7:device/."/>
</hl7:sender>
</xsl:template>
