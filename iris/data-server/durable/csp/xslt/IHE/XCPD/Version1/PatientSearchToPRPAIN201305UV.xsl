...
<xsl:variable name="MothersName" select="./MothersName/Given/text()"/>
<xsl:variable name="FathersName" select="./FathersName/Given/text()"/>
...
<parameterList>
<xsl:if test="$nationalPatientIdentifierAA=''">
<xsl:if test="$Sex!=''">
...
<xsl:if test="MothersMaidenSurname/text()!=''">
<mothersMaidenName>
<value><xsl:value-of select="MothersMaidenSurname/text()"/></value>
