...
<!--
PDQv3 Patient Demographics Query Audit Message (ITI-47)
...
exclude-result-prefixes="isc hl7">
...
<xsl:variable name="eventType" select="'ITI-47,IHE Transactions,Patient Demographics Query'"/>
<xsl:variable name="status"    select="/Root/Response//hl7:acknowledgement/hl7:typeCode/@code"/>
<xsl:variable name="isSource"  select="$actor='PDQv3Consumer'"/>
...
<xsl:apply-templates mode="PDQv3Patient" select="Response//hl7:patient"/>
