...
<!-- *** THIS XSLT STYLESHEET IS DEPRECATED *** -->
	...
	<xsl:template match="/">
		...
		<xsl:apply-templates select="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsQuantity"/>
		...
		<xsl:apply-templates select="f:DeviceMetric/f:measurementPeriod/f:repeat/f:duration"/>
		<xsl:apply-templates select="f:DeviceMetric/f:measurementPeriod/f:repeat/f:period"/>
	...
	<xsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsQuantity">
		<xsl:choose>
			<xsl:when test="not(exists(f:code)) or exists(f:system)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceMetric/f:measurementPeriod/f:repeat/f:boundsQuantity",</xsl:text>
	...
	<xsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:duration">
		<xsl:choose>
			<xsl:when test="@value &gt;= 0 or not(@value)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceMetric/f:measurementPeriod/f:repeat/f:duration",</xsl:text>
	...
	<xsl:template match="f:DeviceMetric/f:measurementPeriod/f:repeat/f:period">
		<xsl:choose>
			<xsl:when test="@value &gt;= 0 or not(@value)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceMetric/f:measurementPeriod/f:repeat/f:period",</xsl:text>
					<xsl:text>"assert":"@value &gt;= 0 or not(@value)",</xsl:text>
