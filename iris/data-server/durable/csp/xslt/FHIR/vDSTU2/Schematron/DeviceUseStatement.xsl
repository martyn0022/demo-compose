...
<!-- *** THIS XSLT STYLESHEET IS DEPRECATED *** -->
	...
	<xsl:template match="/">
		...
		<xsl:apply-templates select="f:DeviceUseStatement/f:bodySiteReference"/>
		...
		<xsl:apply-templates select="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsQuantity"/>
		...
		<xsl:apply-templates select="f:DeviceUseStatement/f:timingTiming/f:repeat/f:duration"/>
		<xsl:apply-templates select="f:DeviceUseStatement/f:timingTiming/f:repeat/f:period"/>
	...
	<xsl:template match="f:DeviceUseStatement/f:bodySiteReference">
		<xsl:choose>
			<xsl:when test="not(starts-with(f:reference/@value, &apos;#&apos;)) or exists(ancestor::*[self::f:entry or self::f:parameter]/f:resource/f:*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, &apos;#&apos;)]|/*/f:contained/f:*[f:id/@value=substring-after(current()/f:reference/@value, &apos;#&apos;)])">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceUseStatement/f:bodySiteReference",</xsl:text>
	...
	<xsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsQuantity">
		<xsl:choose>
			<xsl:when test="not(exists(f:code)) or exists(f:system)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceUseStatement/f:timingTiming/f:repeat/f:boundsQuantity",</xsl:text>
	...
	<xsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:duration">
		<xsl:choose>
			<xsl:when test="@value &gt;= 0 or not(@value)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceUseStatement/f:timingTiming/f:repeat/f:duration",</xsl:text>
	...
	<xsl:template match="f:DeviceUseStatement/f:timingTiming/f:repeat/f:period">
		<xsl:choose>
			<xsl:when test="@value &gt;= 0 or not(@value)">
				<xsl:if test="$includeSuccessfulTests='1'">
					<xsl:text>{"status":1,</xsl:text>
					<xsl:text>"context":"f:DeviceUseStatement/f:timingTiming/f:repeat/f:period",</xsl:text>
					<xsl:text>"assert":"@value &gt;= 0 or not(@value)",</xsl:text>
