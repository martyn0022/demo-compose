...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:variable name="NEHTA_GENERIC_CDA_STYLESHEET_VERSION">1.2.9</xsl:variable>
	...
	<!-- NEHTA Clinical Document Type Names -->
    <xsl:variable name="NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Discharge Summary</xsl:variable>
    <xsl:variable name="NEHTA_SHARED_HEALTH_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Shared Health Summary</xsl:variable>
    <xsl:variable name="NEHTA_E_REFERRAL_CLINICAL_DOCUMENT_TYPE_NAME">e-Referral</xsl:variable>
    <xsl:variable name="NEHTA_SPECIALIST_LETTER_CLINICAL_DOCUMENT_TYPE_NAME">Specialist Letter</xsl:variable>
    <xsl:variable name="NEHTA_EVENT_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Event Summary</xsl:variable>
    <xsl:variable name="NEHTA_E_PRESCRIPTION_CLINICAL_DOCUMENT_TYPE_NAME">e-Prescription</xsl:variable>
    <xsl:variable name="NEHTA_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Dispense Record</xsl:variable>
    <xsl:variable name="NEHTA_PRESCRIPTION_REQUEST_CLINICAL_DOCUMENT_TYPE_NAME">Prescription Request</xsl:variable>
    <xsl:variable name="NEHTA_AUSTRALIAN_CHILDHOOD_IMMUNISATION_REGISTER_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Australian Childhood Immunisation Register</xsl:variable>
    <xsl:variable name="NEHTA_AUSTRALIAN_ORGAN_DONOR_REGISTER_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Australian Organ Donor Register Record</xsl:variable>
    <xsl:variable name="NEHTA_MEDICARE_DVA_BENEFITS_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">Medicare/DVA Benefits Report</xsl:variable>
    <xsl:variable name="NEHTA_ADVANCE_CARE_DIRECTIVE_CUSTODIAN_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Advance Care Directive Custodian Record</xsl:variable>
    <xsl:variable name="NEHTA_PHARMACEUTICAL_BENEFITS_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">Pharmaceutical Benefits Report</xsl:variable>
    <xsl:variable name="NEHTA_CONSUMER_ENTERED_NOTES_CLINICAL_DOCUMENT_TYPE_NAME">Personal Health Note</xsl:variable>
    <xsl:variable name="NEHTA_CONSUMER_ENTERED_HEALTH_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Personal Health Summary</xsl:variable>
    <xsl:variable name="NEHTA_CONSOLIDATED_VIEW_CLINICAL_DOCUMENT_TYPE_NAME">Consolidated View</xsl:variable>
    <xsl:variable name="NEHTA_MEDICARE_INFORMATION_VIEW_CLINICAL_DOCUMENT_TYPE_NAME">Medicare Overview</xsl:variable>
    <xsl:variable name="NEHTA_PCEHR_PRESCRIPTION_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">eHealth Prescription Record</xsl:variable>
    <xsl:variable name="NEHTA_PCEHR_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">eHealth Dispense Record</xsl:variable>
    <xsl:variable name="NEHTA_PCEHR_PRESCRIPTION_AND_DISPENSE_VIEW_CLINICAL_DOCUMENT_TYPE_NAME">PCEHR Prescription and Dispense View</xsl:variable>
    <xsl:variable name="NEHTA_PATHOLOGY_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">Pathology Report</xsl:variable>
    <xsl:variable name="NEHTA_DIAGNOSTIC_IMAGING_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">Diagnostic Imaging Report</xsl:variable>
    <xsl:variable name="NEHTA_ADVANCE_CARE_INFORMATION_CLINICAL_DOCUMENT_TYPE_NAME">Advance Care Information</xsl:variable>
    ...
    <xsl:variable name="cdaDocumentType">
        <xsl:choose>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_DISCHARGE_SUMMARY_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_SHARED_HEALTH_SUMMARY_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_SHARED_HEALTH_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_E_REFERRAL_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_E_REFERRAL_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_SPECIALIST_LETTER_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_SPECIALIST_LETTER_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_EVENT_SUMMARY_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_EVENT_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_E_PRESCRIPTION_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_E_PRESCRIPTION_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_DISPENSE_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PRESCRIPTION_REQUEST_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PRESCRIPTION_REQUEST_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_AUSTRALIAN_CHILDHOOD_IMMUNISATION_REGISTER_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_AUSTRALIAN_CHILDHOOD_IMMUNISATION_REGISTER_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_AUSTRALIAN_ORGAN_DONOR_REGISTER_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_AUSTRALIAN_ORGAN_DONOR_REGISTER_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_MEDICARE_DVA_BENEFITS_REPORT_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_MEDICARE_DVA_BENEFITS_REPORT_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PHARMACEUTICAL_BENEFITS_REPORT_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PHARMACEUTICAL_BENEFITS_REPORT_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_ADVANCE_CARE_DIRECTIVE_CUSTODIAN_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_ADVANCE_CARE_DIRECTIVE_CUSTODIAN_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_CONSUMER_ENTERED_NOTES_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_CONSUMER_ENTERED_NOTES_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_CONSUMER_ENTERED_HEALTH_SUMMARY_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_CONSUMER_ENTERED_HEALTH_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_CONSOLIDATED_VIEW_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_CONSOLIDATED_VIEW_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_MEDICARE_INFORMATION_VIEW_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_MEDICARE_INFORMATION_VIEW_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PCEHR_PRESCRIPTION_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PCEHR_PRESCRIPTION_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PCEHR_DISPENSE_RECORD_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PCEHR_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PCEHR_PRESCRIPTION_AND_DISPENSE_VIEW_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PCEHR_PRESCRIPTION_AND_DISPENSE_VIEW_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_PATHOLOGY_REPORT_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_PATHOLOGY_REPORT_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_DIAGNOSTIC_IMAGING_REPORT_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_DIAGNOSTIC_IMAGING_REPORT_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            <xsl:when test="/cda:ClinicalDocument/cda:templateId[@root=$NEHTA_ADVANCE_CARE_INFORMATION_CDA_IMPLEMENTATION_GUIDE_OID]"><xsl:value-of select="$NEHTA_ADVANCE_CARE_INFORMATION_CLINICAL_DOCUMENT_TYPE_NAME"/></xsl:when>
            ...
            <xsl:element name="body">
                ...
                <xsl:element name="div">
                    ...
                    <xsl:element name="div">
                        ...
                        <xsl:choose>
                            <xsl:when test="$cdaDocumentType=$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">
        ...
        <xsl:variable name="completionCode">
            ...
            <xsl:element name="div">
                <xsl:attribute name="class">BANNER_DOCUMENT_DATE_DIV</xsl:attribute>
                    <xsl:choose>
                        <xsl:when test="$cdaDocumentType=$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME and (string-length($encounterEndDate) &gt; 0)"><xsl:value-of select="$encounterEndDate"/></xsl:when>
                            ...
                            <xsl:element name="div">
                                <xsl:element name="table">
                                    ...
                                    <xsl:element name="tbody">
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="$cdaDocumentType = $NEHTA_EVENT_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">
                                                <xsl:choose>
                                            ...
                                            <xsl:when test="$cdaDocumentType = $NEHTA_DIAGNOSTIC_IMAGING_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">
        ...
        <xsl:if test="$encounterStartDateTime != '' or
            ...
            <xsl:element name="table">
                ...
                <xsl:element name="tbody">
                        ...
                        <xsl:element name="tr">
                            <xsl:element name="th">
                                ...
                                <xsl:element name="span">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="$cdaDocumentType=$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Admission Date</xsl:when>
                        ...
                        <xsl:element name="tr">
                            <xsl:element name="th">
                                ...
                                <xsl:element name="span">
                                    <xsl:attribute name="class">detailsHalfTableThSpan</xsl:attribute>
                                    <xsl:choose>
                                        <xsl:when test="$cdaDocumentType=$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME">Discharge Date</xsl:when>
                        ...
                        <xsl:element name="tr">
                            <xsl:element name="th">
                                ...
                                <xsl:element name="span">
                                    <xsl:attribute name="class">detailsHalfTableThSpan</xsl:attribute>
                                    <xsl:choose>
                                        <xsl:when test="$cdaDocumentType=$NEHTA_SPECIALIST_LETTER_CLINICAL_DOCUMENT_TYPE_NAME">Date/Time Subject of Care Seen</xsl:when>
                    ...
                    <xsl:if test="$cdaDocumentType=$NEHTA_DISCHARGE_SUMMARY_CLINICAL_DOCUMENT_TYPE_NAME and
                                  $dischargeLocation!=''">
                        <xsl:element name="tr">
                            <xsl:element name="th">
                                <xsl:attribute name="class">detailsHalfTableTh</xsl:attribute>
    ...
    <xsl:template name="getSignificantParticipant">
        ...
        <xsl:if test="$participant/cda:associatedEntity/cda:associatedPerson/cda:name and
            ...
            <xsl:element name="table">
                <xsl:attribute name="class">detailsHalfTable</xsl:attribute>
                <xsl:element name="tbody">
                    <xsl:if test="($cdaDocumentType=$NEHTA_PATHOLOGY_REPORT_CLINICAL_DOCUMENT_TYPE_NAME or $cdaDocumentType=$NEHTA_DIAGNOSTIC_IMAGING_REPORT_CLINICAL_DOCUMENT_TYPE_NAME) and
                        ...
                        <xsl:variable name="orderID">
                            <xsl:choose>
                                <xsl:when test="$cdaDocumentType=$NEHTA_PATHOLOGY_REPORT_CLINICAL_DOCUMENT_TYPE_NAME">
    ...
    <xsl:template name="getFacilityDetails">
        <xsl:if test="/cda:ClinicalDocument/cda:componentOf/cda:encompassingEncounter/cda:location/cda:healthCareFacility/cda:serviceProviderOrganization/cda:asOrganizationPartOf/cda:wholeOrganization/cda:name and 
            ...
            <xsl:element name="div">
                <xsl:attribute name="class">detailsHalfTableHeaderDiv</xsl:attribute>
                <xsl:choose>
                    <xsl:when test="$cdaDocumentType=$NEHTA_PCEHR_PRESCRIPTION_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Prescriber Organisation</xsl:when>
                    <xsl:when test="$cdaDocumentType=$NEHTA_PCEHR_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Dispensing Organisation</xsl:when>
            ...
            <xsl:element name="table">
                ...
                <xsl:element name="tr">
                    ...
                    <xsl:element name="td">
                        ...
                        <xsl:if test="$cdaDocumentType=$NEHTA_PCEHR_PRESCRIPTION_RECORD_CLINICAL_DOCUMENT_TYPE_NAME or $cdaDocumentType=$NEHTA_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">
                            <xsl:call-template name="getFacilityDetails"/>
                        </xsl:if>
                    </xsl:element> <!-- </td> -->
                    <xsl:element name="td">
                ...
                <xsl:choose>
                    <xsl:when test="$cdaDocumentType=$NEHTA_E_REFERRAL_CLINICAL_DOCUMENT_TYPE_NAME and
                    ...
                    <xsl:when test="$cdaDocumentType=$NEHTA_SPECIALIST_LETTER_CLINICAL_DOCUMENT_TYPE_NAME and
                    ...
                    <xsl:when test="($cdaDocumentType=$NEHTA_PATHOLOGY_REPORT_CLINICAL_DOCUMENT_TYPE_NAME or $cdaDocumentType=$NEHTA_DIAGNOSTIC_IMAGING_REPORT_CLINICAL_DOCUMENT_TYPE_NAME) and
    ...
    <xsl:template name="getAuthorDetails">
        ...
        <xsl:element name="div">
            <xsl:attribute name="class">detailsHalfTableHeaderDiv</xsl:attribute>
            <xsl:choose>
                <xsl:when test="$cdaDocumentType=$NEHTA_PCEHR_PRESCRIPTION_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Prescriber</xsl:when>
                <xsl:when test="$cdaDocumentType=$NEHTA_PCEHR_DISPENSE_RECORD_CLINICAL_DOCUMENT_TYPE_NAME">Dispenser</xsl:when>
                <xsl:otherwise>Author</xsl:otherwise>
            </xsl:choose>
        </xsl:element> <!-- </div> -->
        <xsl:element name="table">
