	...
	<xsl:template match="*" mode="documentationOf-FamilyDoctor">
				...
				<performer typeCode="PRF">
					...
					<!--
						...
						Target: /ClinicalDocument/documentationOf/serviceEvent/performer[(functionCode/@codeSystem='2.16.840.1.113883.12.443' and functionCode/@code='PP')]/assignedEntity
