...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc xsi sdtc exsl set">
  ...
  <!-- If you wish to block exporting vaccination(s) with zero administrations (default), export profile code should be 0.
	   If you wish to include exporting vaccination(s) with zero administrations, export profile code should be 1.-->
  <xsl:variable name="checkAdministrations" select="$exportConfiguration/immunizations/checkAdministrations/text()"/>
	...
	<xsl:template match="*" mode="immunizations-Narrative">
		<text>
			<table border="1" width="100%">
				...
				<tbody>
				  <xsl:choose>
				    <xsl:when test="$checkAdministrations='1'">
						<xsl:apply-templates select="Vaccinations/Vaccination[not(contains($immunizationCancelledStatusCodes, concat('|', Status/text(), '|'))) and not(Administrations/Administration)] | Vaccinations/Vaccination[not(contains($immunizationCancelledStatusCodes, concat('|', Status/text(), '|')))]/Administrations/Administration" mode="immunizations-NarrativeDetail-Combined"/>					
					</xsl:when>
					<xsl:otherwise>
					    <xsl:apply-templates select="Vaccinations/Vaccination[not(contains($immunizationCancelledStatusCodes, concat('|', Status/text(), '|')))]/Administrations/Administration" mode="immunizations-NarrativeDetail"/>					
					</xsl:otherwise>
				  </xsl:choose>
				</tbody>
			</table>
    ...
    <!-- This template exports a combines list of Vaccinations with no administrations plus Vaccinations with administrations-->
    <xsl:template match="*" mode="immunizations-NarrativeDetail-Combined">
	  <xsl:variable name="narrativeLinkSuffix" select="position()"/>		
		...
		<tr ID="{concat($exportConfiguration/immunizations/narrativeLinkPrefixes/immunizationNarrative/text(), $narrativeLinkSuffix)}">
			<td ID="{concat($exportConfiguration/immunizations/narrativeLinkPrefixes/immunizationOrderedName/text(), $narrativeLinkSuffix)}">
				<xsl:choose>
				  <xsl:when test="local-name()='Vaccination'">
					<xsl:apply-templates select="OrderItem" mode="originalTextOrDescriptionOrCode"/>
				  </xsl:when>
				  <xsl:otherwise>
					<xsl:apply-templates select="../../OrderItem" mode="originalTextOrDescriptionOrCode"/>
				  </xsl:otherwise>
			...
			<td ID="{concat($exportConfiguration/immunizations/narrativeLinkPrefixes/immunizationFilledName/text(), $narrativeLinkSuffix)}">
				<xsl:choose>
				  <xsl:when test="local-name()='Vaccination'">
					<xsl:apply-templates select="DrugProduct" mode="originalTextOrDescriptionOrCode"/>
				  </xsl:when>
				  <xsl:otherwise>
					<xsl:apply-templates select="../../DrugProduct" mode="originalTextOrDescriptionOrCode"/>
				  </xsl:otherwise>
			...
			<td>
				<xsl:choose>
				  <xsl:when test="local-name()='Vaccination'">
					<xsl:apply-templates select="Status" mode="immunization-statusDescription"/>
				  </xsl:when>
				  <xsl:otherwise>
					<xsl:apply-templates select="../../Status" mode="immunization-statusDescription"/>
				  </xsl:otherwise>
	...
	<xsl:template match="*" mode="immunizations-Entries">
		<xsl:choose>
		<xsl:when test="$checkAdministrations='1'">
			<xsl:apply-templates select="Vaccinations/Vaccination[not(contains($immunizationCancelledStatusCodes, concat('|', Status/text(), '|'))) and not(Administrations/Administration)] | Vaccinations/Vaccination/Administrations/Administration" mode="immunizations-EntryDetail-Combined"/>
		</xsl:when>
		<xsl:otherwise>
			<xsl:apply-templates select="Vaccinations/Vaccination[not(contains($immunizationCancelledStatusCodes, concat('|', Status/text(), '|')))]/Administrations/Administration" mode="immunizations-EntryDetail"/>
		</xsl:otherwise>
		</xsl:choose>
	</xsl:template>

	<xsl:template match="*" mode="immunizations-EntryDetail-Combined">
		<xsl:variable name="narrativeLinkSuffix" select="position()"/>		
		...
		<entry typeCode="DRIV">
			<substanceAdministration classCode="SBADM" negationInd="false">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/id[1]
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/id[2]
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/id[3]
				...
				<xsl:choose>
				  <xsl:when test="local-name()='Vaccination'">
					<xsl:apply-templates select="." mode="effectiveTime-Immunization-NoAdmin"/>
				  </xsl:when>
				  <xsl:otherwise>
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/performer
				...
				<xsl:choose>
				  ...
				  <xsl:otherwise>
					<author typeCode="AUT">
						...
						<xsl:apply-templates select="../../EnteredBy" mode="assignedAuthor-Human"/>
					</author>
				  </xsl:otherwise>
				</xsl:choose>
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/informant
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship/act[code/@code='48767-8']/text
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship
	...
	<xsl:template match="*" mode="immunizations-EntryDetail">
		...
		<entry typeCode="DRIV">
			<substanceAdministration classCode="SBADM" negationInd="false">
				...
				<!--
					Field : Immunization Author
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/author
					Source: HS.SDA3.AbstractOrder EnteredBy
					Source: /Container/Vaccinations/Vaccination/EnteredBy
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/author/time
					Source: HS.SDA3.Administration EnteredOn
					Source: /Container/Vaccinations/Vaccination/Administrations/Administration/EnteredOn
				-->				
				<author typeCode="AUT">
					<xsl:choose>
						<xsl:when test="string-length(EnteredOn)">
		...
		<consumable typeCode="CSM">
			<manufacturedProduct classCode="MANU">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/consumable/manufacturedProduct/manufacturedMaterial
					...
					Note  : SDA Vaccination OrderItem is exported to CDA consumable
							to indicate the product that was actually ordered.
				-->
		...
		<entryRelationship typeCode="REFR">
			<supply classCode="SPLY" moodCode="EVN">
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/id
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial
					Source: HS.SDA3.AbstractOrder OrderItem
					Source: /Container/Vaccinations/Vaccination/OrderItem
					StructuredMappingRef: immunization-manufacturedMaterial
					Note  : SDA Vaccination DrugProduct is exported to CDA supply
							with moodCode='EVN' to indicate the actual product
	...
	<xsl:template match="*" mode="effectiveTime-Immunization">
		<!--
			...
			Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.23']/entry/substanceAdministration/effectiveTime/@value
			Source: HS.SDA3.Administration FromTime
			Source: /Container/Vaccinations/Vaccination/Administrations/Administration/FromTime
			Note  : CDA effectiveTime for Immunization uses only a single time value: Administration FromTime
		-->
		<xsl:choose>
	...
	<xsl:template match="*" mode="effectiveTime-Immunization-NoAdmin">
		<!--
			Field : Immunization Administered Date/Time
