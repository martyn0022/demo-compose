...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc xsi sdtc exsl set">
		...
		<entry typeCode="DRIV">
			<act classCode="ACT" moodCode="EVN">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/performer
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/author
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/informant
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/act[code/@code='48767-8']/text
	...
	<xsl:template match="*" mode="allergies-NoData">
		...
		<text><content ID="noAllergies-1"><xsl:value-of select="$exportConfiguration/allergies/emptySection/narrativeText/text()"/></content></text>
		<entry typeCode="DRIV">
			<act classCode="ACT" moodCode="EVN">
	...
	<xsl:template match="*" mode="allergies-Detail">
		...
		<entryRelationship typeCode="SUBJ" inversionInd="false">
			<observation classCode="OBS" moodCode="EVN">
				...
				<!--
					Field : Allergy Type
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/code
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/effectiveTime/low/@value
					Source: HS.SDA3.Allergy FromTime
					Source: /Container/Allergies/Allergy/FromTime
				-->
				<!--
					Field : Allergy End Date
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/effectiveTime/high/@value
		...
		<participant typeCode="CSM">
			<participantRole classCode="MANU">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/participant/participantRole/playingEntity/code
	...
	<xsl:template match="*" mode="observation-Reaction">
		...
		<entryRelationship typeCode="MFST" inversionInd="true">
			<observation classCode="OBS" moodCode="EVN">
				...
				<!--
					Field : Allergy Start Date
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/entryRelationship[@typeCode='MFST']/observation/effectiveTime/low/@value
					Source: HS.SDA3.Allergy FromTime
					Source: /Container/Allergies/Allergy/FromTime
				-->
				<!--
					Field : Allergy End Date
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/entryRelationship[@typeCode='MFST']/observation/effectiveTime/high/@value
					Source: HS.SDA3.Allergy ToTime
					Source: /Container/Allergies/Allergy/ToTime
				-->
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/entryRelationship[@typeCode='MFST']/observation/value
		...
		<entryRelationship typeCode="SUBJ" inversionInd="true">
			<observation classCode="OBS" moodCode="EVN">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/entryRelationship/observation[code/@code='SEV']/value
		...
		<entryRelationship typeCode="REFR" inversionInd="false">
			<observation classCode="OBS" moodCode="EVN">
				...
				<!--
					...
					Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/entryRelationship/observation[code/@code='33999-4']/value/@code
	...
	<xsl:template match="*" mode="statusCode-Allergy">
		<!--
			Field : Allergy Status
			Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/statusCode/@code
			Source: HS.SDA3.Allergy Status
			Source: /Container/Allergies/Allergy/Status
		...
		<!--
			Field : Allergy Start Date
			Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/effectiveTime/low/@value
			Source: HS.SDA3.Allergy FromTime
			Source: /Container/Allergies/Allergy/FromTime
		-->
		<!--
			Field : Allergy End Date
			Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/effectiveTime/high/@value
			Source: HS.SDA3.Allergy ToTime
			Source: /Container/Allergies/Allergy/ToTime
		-->
		<xsl:apply-templates select="." mode="effectiveTime-FromTo">
	...
	<xsl:template match="Allergy" mode="id-AllergyProblem">
		<!--
			...
			Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/id
	...
	<xsl:template match="Allergy" mode="id-AllergyObservation">
		<xsl:choose>
			...
			<!--
				...
				Target: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.13']/entry/act/entryRelationship/observation/id
				Source: HS.SDA3.Allergy ExternalId
				Source: /Container/Allergies/Allergy/ExternalId
				StructuredMappingRef: id-External
