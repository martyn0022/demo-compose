...
<xsl:stylesheet version="1.0" xmlns="urn:hl7-org:v3" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns:isc="http://extension-functions.intersystems.com" xmlns:exsl="http://exslt.org/common" xmlns:set="http://exslt.org/sets" exclude-result-prefixes="isc xsi sdtc exsl set">
	...
	<xsl:template match="*" mode="pastIllness">
		...
		<!--
			An SDA Problem qualifies for CDA History of Past Illness when
			its Status does not indicate a current condition OR when the
			Problem is older than a defined number of days.  Otherwise,
			it will get exported to CDA Problem List.
			
			Parameters governing current condition status codes and window
			of time are found in CDA-Support-Files/Site/ExportProfile.xml.
		-->
