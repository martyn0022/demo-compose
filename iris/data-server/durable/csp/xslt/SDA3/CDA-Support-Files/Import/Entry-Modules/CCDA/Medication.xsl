...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="*" mode="Medication">
		...
		<xsl:element name="{$elementName}">
			...
			<xsl:if test="$medicationType!='VXU'">
				<xsl:apply-templates select="." mode="AuthorTime"/>
			</xsl:if> 
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.1.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/repeatNumber/@value
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.38']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/repeatNumber/@value
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.11.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/repeatNumber/@value
			...
			<!-- Free-text SIG -->
			<xsl:if test="$medicationType='MED' or $medicationType='MEDPOC'"><xsl:apply-templates select="hl7:text" mode="Signature"/></xsl:if>
			...
			<xsl:if test="$medicationType='VXU'">
				...
				<xsl:if test="(count($authorTimes) = 1) or (count($startTimes) = 1) or (count($endTimes) = 1)">
					<Administrations>
						<Administration>
	...
	<xsl:template match="*" mode="DrugProduct">
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.1.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/code
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.38']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/code
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.11.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/code
			StructuredMappingRef: CodeTableDetail
		-->
		<!--
			Field : Immunization Coded Product Name
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.2.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/code
			StructuredMappingRef: CodeTableDetail
		-->
		...
		<DrugProduct>		
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.1.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/name
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.38']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/name
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.11.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/name
			-->
			<!--
				Field : Immunization Text Product Name
				Target: HS.SDA3.AbstractMedication DrugProduct.ProductName
				Target: /Container/Vaccinations/Vaccination/DrugProduct/ProductName
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.2.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/product/manufacturedProduct/manufacturedMaterial/name
			-->
	...
	<xsl:template match="*" mode="DrugProductQuantity">
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.1.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@value
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.38']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@value
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.11.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@value
		-->
		<!--
			Field : Immunization Quantity Ordered
			Target: HS.SDA3.DrugProduct BaseQty
			Target: /Container/Vaccinations/Vaccination/DrugProduct/BaseQty
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.2.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@value
		-->
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.1.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@unit
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.38']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@unit
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.11.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@unit
		-->
		<!--
			Field : Immunization Quantity Ordered Unit
			Target: HS.SDA3.DrugProduct BaseUnits
			Target: /Container/Vaccinations/Vaccination/DrugProduct/BaseUnits
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.2.1']/entry/substanceAdministration/entryRelationship/supply[@moodCode='EVN']/quantity/@unit
		-->
	...
	<xsl:template match="*" mode="Indication">
		...
		<xsl:variable name="originalTextReferenceLink" select="substring-after(hl7:observation/hl7:value/hl7:originalText/hl7:reference/@value, '#')"/>
		<xsl:variable name="originalTextReferenceValue">
			<xsl:choose>
				<xsl:when test="string-length($originalTextReferenceLink)">
		...
		<xsl:variable name="indication">
			<xsl:choose>
				<xsl:when test="string-length(hl7:observation/hl7:value/@displayName)">
					<xsl:value-of select="hl7:observation/hl7:value/@displayName"/>
				</xsl:when>
				<xsl:when test="string-length($originalTextReferenceValue)">
					<xsl:value-of select="$originalTextReferenceValue"/>
				</xsl:when>
				<xsl:when test="string-length(hl7:observation/hl7:value/@code)">
					<xsl:value-of select="hl7:observation/hl7:value/@code"/>
				</xsl:when>
				<xsl:when test="string-length(hl7:observation/hl7:value/hl7:translation/@displayName)">
					<xsl:value-of select="hl7:observation/hl7:value/hl7:translation/@displayName"/>
				</xsl:when>
				<xsl:when test="string-length(hl7:observation/hl7:value/hl7:translation/@code)">
					<xsl:value-of select="hl7:observation/hl7:value/hl7:translation/@code"/>
				</xsl:when>
			</xsl:choose>
		</xsl:variable>
	...
	<xsl:template match="*" mode="AuthorTime">
		<!--
