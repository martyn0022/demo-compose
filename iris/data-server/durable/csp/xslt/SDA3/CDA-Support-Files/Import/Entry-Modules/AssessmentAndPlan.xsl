...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="hl7:act" mode="AssessmentAndPlan-EntryDetail">
		<Document>
			...
			<xsl:if test="string-length(hl7:id/@root)">
				...
				<!--
					...
					Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/id
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/entryRelationship/encounter/id
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/entryRelationship/act[code/@code='48767-8']/text
			...
			<!--
				...
				Target: HS.SDA3.Document NoteText
				Target: /Container/Documents/Document/NoteText
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/text/reference/@value
				Note  : The Document NoteText is imported from the first found of CDA comment
						entryRelationship, the text element, or code/originalText.
			-->
			<!--
				...
				Target: HS.SDA3.Document NoteText
				Target: /Container/Documents/Document/NoteText
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/code/originalText/reference/@value
				Note  : The Document NoteText is imported from the first found of CDA comment
						entryRelationship, the text element, or code/originalText.
			-->
			<xsl:choose>
				...
				<xsl:otherwise>
					...
					<xsl:choose>
						<xsl:when test="string-length(normalize-space($textReferenceValue))"><NoteText><xsl:value-of select="$textReferenceValue"/></NoteText></xsl:when>
						<xsl:when test="string-length(normalize-space(hl7:text/text()))"><NoteText><xsl:value-of select="hl7:text/text()"/></NoteText></xsl:when>
						<xsl:when test="string-length(normalize-space($originalTextReferenceValue))"><NoteText><xsl:value-of select="$originalTextReferenceValue"/></NoteText></xsl:when>
						<xsl:when test="string-length(normalize-space(hl7:code/hl7:originalText/text()))"><NoteText><xsl:value-of select="hl7:code/hl7:originalText/text()"/></NoteText></xsl:when>
					</xsl:choose>
				</xsl:otherwise>
			</xsl:choose>
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/code/@displayName
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/code/@code
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.2.7']/entry/act/code/@codeSystem
			...
			<CustomPairs>
				...
				<xsl:apply-templates select="hl7:code" mode="CodeTable-CustomPair">
					<xsl:with-param name="hsElementName" select="'DocumentName'"/>
				</xsl:apply-templates>
			...
			<!-- Custom SDA Data-->
			<xsl:apply-templates select="." mode="ImportCustom-AssessmentAndPlan"/>
		</Document>
	</xsl:template>
  ...
  <!--
	...
	-->
  <xsl:template match="*" mode="ImportCustom-AssessmentAndPlan">
  </xsl:template>
