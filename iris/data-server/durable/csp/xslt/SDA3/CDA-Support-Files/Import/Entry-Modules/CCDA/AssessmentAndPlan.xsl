	...
	<xsl:template match="hl7:act" mode="AssessmentAndPlan-EntryDetail">
		<Document>
			...
			<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.9']/entry/act/entryRelationship/act[code/@code='48767-8']/text
