...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="*" mode="MedicationsSection">
		<xsl:apply-templates select="$sectionRootPath[hl7:templateId/@root=$medicationsSectionTemplateId]" mode="MedicationsSectionEntries"/>	
	</xsl:template>
	...
	<!-- Determine if a Medications section is present but has or indicates no data present.
		...
		The input node spec is the $sectionRootPath for the Medications, Discharge Medications, or Medications Administered section.
