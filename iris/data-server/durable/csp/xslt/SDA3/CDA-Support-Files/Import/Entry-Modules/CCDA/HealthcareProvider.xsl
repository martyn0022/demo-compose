...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="*" mode="HealthcareProvider">
		...
		-->
		<xsl:apply-templates select="hl7:serviceEvent/hl7:performer[(hl7:functionCode/@codeSystem=$participationFunctionOID and hl7:functionCode/@code='PCP') or (hl7:functionCode/@codeSystem=$providerRoleOID and hl7:functionCode/@code='PP')][1]" mode="FamilyDoctor"/>
	</xsl:template>
</xsl:stylesheet>
