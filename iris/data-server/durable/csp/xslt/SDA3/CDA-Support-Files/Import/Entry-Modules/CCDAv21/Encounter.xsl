...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:hl7="urn:hl7-org:v3" xmlns:sdtc="urn:hl7-org:sdtc"
  ...
  <xsl:template match="hl7:encompassingEncounter" mode="eE-DefaultEncounter">
	    ...
	    <Encounters>
	      <Encounter>
			...
			<!--
					Field : Encompassing Encounter Number Assigning Authority
					Target: HS.SDA3.Encounter EncounterNumberAssigningAuthority
					Target: /Container/Encounters/Encounter/EncounterNumberAssigningAuthority
					Source: /ClinicalDocument/componentOf/encompassingEncounter/id[2]/@root
			-->
			<EncounterNumberAssigningAuthority>
			...
			<!-- 
					Map encounterParticipant (or performer) to the newer Participants collection, 
					while also continuing to map it to the older properties: AdmittingClinician,
					AttendingClinicians, ConsultingClinicians, and ReferringClinician.
			-->
	        <!--
					Field : Encompassing Encounter Participant
					Target: HS.SDA3.Encounter Participants
					Target: /Container/Encounters/Encounter/Participants
					Source: /ClinicalDocument/componentOf/encompassingEncounter/encounterParticipant
					StructuredMappingRef: EncounterParticipants
			-->
			<xsl:if test="(count(hl7:encounterParticipant[@typeCode]) > 0) or (count(hl7:performer[@typeCode]) > 0)" >
				<Participants>
					<xsl:apply-templates select="." mode="fn-EncounterParticipants"/>
				</Participants>
			</xsl:if>
	        ...
	        <xsl:choose>
	          <xsl:when test="hl7:location">
				...
				<Locations>
					<xsl:apply-templates select="hl7:location" mode="fn-HealthCareFacilityLocation"/>
				</Locations>
	          </xsl:when>
	          <xsl:otherwise>
			...
			<!--
					Field : Encompassing Encounter Status
					Target: HS.SDA3.Encounter Status
					Target: /Container/Encounters/Encounter/Status
					Source: /ClinicalDocument/componentOf/encompassingEncounter/effectiveTime
					Note  : Status is set to "finished" if effectiveTime is a single timestamp
							or containes both low and high values. If effective time has only a 
							low value, Status is set to "in-progress".
			-->
			<xsl:choose>
				<xsl:when test="string-length($toTime)">
					<Status>
						<SDACodingStandard>http://hl7.org/fhir/encounter-status</SDACodingStandard>
						<Code>finished</Code>
			...
			<!--
					Field : Encompassing Encounter Separation Mode
					Target: HS.SDA3.Encounter SeparationMode
					Target: /Container/Encounters/Encounter/SeparationMode
					Source: /ClinicalDocument/componentOf/encompassingEncounter/dischargeDispositionCode
					StructuredMappingRef: CodeTableDetail
			-->
			<xsl:apply-templates select="hl7:dischargeDispositionCode" mode="fn-CodeTable">
				<xsl:with-param name="hsElementName" select="'SeparationMode'"/>
			</xsl:apply-templates>
	    ...
	    <Encounters>
	      <Encounter>
	        ...
	        <!--
					...
					Target: /Container/Encounters/Encounter/Participants
					Source: /ClinicalDocument/componentOf/encompassingEncounter/encounterParticipant
					StructuredMappingRef: EncounterParticipant
			-->
			<xsl:if test="(count(hl7:encounterParticipant[@typeCode]) > 0) or (count(hl7:performer[@typeCode]) > 0)" >
				<Participants>
					<xsl:apply-templates select="." mode="fn-EncounterParticipants"/>
					<xsl:apply-templates select="." mode="fn-EncounterParticipants-informants"/>
				</Participants>
			</xsl:if>
			...
			<!--
					...
					Target: HS.SDA3.Encounter Status
					Target: /Container/Encounters/Encounter/Status
					Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.22.1']/entry/encounter/statusCode
					Note  : If statusCode is not present, Status is set based on effectiveTime. It will 
							have a value or "finished" if effectiveTime is a single timestamp or contains
							both low and high values. If effective time has only a low value, Status is 
							set to "in-progress".
			-->
			<xsl:choose>
				<xsl:when test="hl7:statusCode">
					<xsl:apply-templates select="hl7:statusCode" mode="eE-EncounterStatus"/>
				</xsl:when>
				<xsl:when test="string-length($toTime)">
					<Status>
						<SDACodingStandard>http://hl7.org/fhir/encounter-status</SDACodingStandard>
			...
			<!--
					...
					Target: HS.SDA3.Encounter SeparationMode
					Target: /Container/Encounters/Encounter/SeparationMode
					Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.22.1']/entry/encounter/sdtc:dischargeDispositionCode
					StructuredMappingRef: CodeTableDetail
			-->
			<xsl:apply-templates select="sdtc:dischargeDispositionCode" mode="fn-CodeTable">
				<xsl:with-param name="hsElementName" select="'SeparationMode'"/>
			</xsl:apply-templates>

			<!--
					Field : Encompassing Encounter Indication
					Target: HS.SDA3.Encounter AdmitReasonReference
					Target: HS.SDA3.Encounter AdmitReason
					Target: /Container/Encounters/Encounter/AdmitReasonReference
					Target: /Container/Encounters/Encounter/AdmitReason
					Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.22.1']/entry/encounter/entryRelationship[@typeCode='RSON']/observation
					Note: If the observation has a matching entry somewhere else in the document, AdmitReasonReference
						  will be populated with a reference to the SDA version of that observation. Otherwise, the
						  observation will be transformed into a CodeTableDetail and stored in AdmitReason
			-->
			<xsl:apply-templates select="hl7:entryRelationship[@typeCode='RSON']/hl7:observation" mode="eE-Indication"/>

			<!--
					Field : Encompassing Encounter Diagnosis
					Target: HS.SDA3.Encounter DiagnosisReference
					Target: /Container/Encounters/Encounter/DiagnosisReference
					Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.22.1']/entry/encounter/entryRelationship/act[hl7:code/@code='29308-4']/entryRelationship[@typeCode='SUBJ']/observation
			-->
			<xsl:if test="hl7:entryRelationship/hl7:act[hl7:code/@code='29308-4']/hl7:entryRelationship[@typeCode='SUBJ']/hl7:observation">
				<DiagnosisReference>
					<xsl:for-each select="hl7:entryRelationship/hl7:act[hl7:code/@code='29308-4']/hl7:entryRelationship[@typeCode='SUBJ']/hl7:observation">
						<Reference>
							<xsl:choose>
								<xsl:when test="hl7:id and not(hl7:id/@nullFlavor)">
									<xsl:apply-templates select="hl7:id" mode="fn-SdaId"/>
								</xsl:when>
								<xsl:when test="hl7:id/@nullFlavor">
									<SdaID>
										<xsl:value-of select="generate-id(hl7:id)"/>
									</SdaID>
								</xsl:when>
								<xsl:otherwise>
									<SdaID>
  ...
  <xsl:template match="hl7:ClinicalDocument" mode="eE-DuplicatedEncounter">
	    ...
	    <Encounters>    	
	      <Encounter>
			...
			<!-- EncounterNumberAssigningAuthority -->
			<EncounterNumberAssigningAuthority>
	          <xsl:value-of select="$encompassingEncounterRootPath/hl7:id/@root"/>
	        </EncounterNumberAssigningAuthority>
			...
			-->
	        <!--
					HS.SDA3.Encounter Participants
			-->
 	        <xsl:apply-templates select="." mode="eE-EncounterParticipantsDuplicate">
	        ...
	        <xsl:choose>
	          <xsl:when test="$encompassingEncounterRootPath/hl7:location">
				...
				<Locations>
					<xsl:apply-templates select="$encompassingEncounterRootPath/hl7:location" mode="fn-HealthCareFacilityLocation"/>
				</Locations>
	          </xsl:when>
	          <xsl:otherwise>
			...
			<!--
				HS.SDA3.Encounter Status
			-->
			<xsl:choose>
				<xsl:when test="$overriddenEncounterRootPath/hl7:statusCode">
					<xsl:apply-templates select="$overriddenEncounterRootPath/hl7:statusCode" mode="eE-EncounterStatus"/>
				</xsl:when>
				<xsl:when test="string-length($toTime)">
					<Status>
						<SDACodingStandard>http://hl7.org/fhir/encounter-status</SDACodingStandard>
			...
			-->
			<xsl:choose>
				<xsl:when test="$overriddenEncounterRootPath/sdtc:dischargeDispositionCode">
					<xsl:apply-templates select="$overriddenEncounterRootPath/sdtc:dischargeDispositionCode" mode="fn-CodeTable">
						<xsl:with-param name="hsElementName" select="'SeparationMode'"/>
					</xsl:apply-templates>
				</xsl:when>
				<xsl:otherwise>
					<xsl:apply-templates select="$encompassingEncounterRootPath/hl7:dischargeDispositionCode" mode="fn-CodeTable">
						<xsl:with-param name="hsElementName" select="'SeparationMode'"/>
					</xsl:apply-templates>
				</xsl:otherwise>
			</xsl:choose>
			...
			<!--
				HS.SDA3.Encounter AdmitReasonReference
				HS.SDA3.Encounter AdmitReason
			-->
			<xsl:apply-templates select="$overriddenEncounterRootPath/hl7:entryRelationship[@typeCode='RSON']/hl7:observation" mode="eE-Indication"/>

			<!--
				HS.SDA3.Encounter DiagnosisReference
			-->
			<xsl:if test="$overriddenEncounterRootPath/hl7:entryRelationship/hl7:act[hl7:code/@code='29308-4']/hl7:entryRelationship[@typeCode='SUBJ']/hl7:observation">
				<DiagnosisReference>
					<xsl:for-each select="$overriddenEncounterRootPath/hl7:entryRelationship/hl7:act[hl7:code/@code='29308-4']/hl7:entryRelationship[@typeCode='SUBJ']/hl7:observation">
						<Reference>
							<xsl:choose>
								<xsl:when test="hl7:id and not(hl7:id/@nullFlavor)">
									<xsl:apply-templates select="hl7:id" mode="fn-SdaId"/>
  ...
  <xsl:template match="*" mode="eE-EncounterParticipantsDuplicate">
    <xsl:param name="overriddenEncounterRootPath"/>
	<xsl:param name="encompassingEncounterRootPath"/>
    <!--
			EncounterParticipantsDuplicate de-duplicates the 
			clinicians between the encompassingEncounter and the
			Encounters section encounter, based on assignedEntity/id.
	-->
    <xsl:variable name="encompassingEncounterParticipantIds">
   		<xsl:for-each select="$encompassingEncounterRootPath/hl7:assignedEntity">
			<xsl:value-of select="concat('|', hl7:id/@root, '/', hl7:id/@extension, '|')"/>
        </xsl:for-each>
   	</xsl:variable>

	<xsl:if test="(count($encompassingEncounterRootPath/hl7:encounterParticipant[@typeCode]) > 0) or (count(overriddenEncounterRootPath/hl7:performer[@typeCode]) > 0)" >
	  	<Participants>
			<xsl:apply-templates select="$encompassingEncounterRootPath" mode="fn-EncounterParticipants"/>
			<xsl:apply-templates
	      		select="$overriddenEncounterRootPath[not(string-length(hl7:performer/hl7:assignedEntity/hl7:id/@root)
	        			and contains($encompassingEncounterParticipantIds, concat('|', hl7:performer/hl7:assignedEntity/hl7:id/@root, '/', hl7:performer/hl7:assignedEntity/hl7:id/@extension, '|')))]"
	      		 mode="fn-EncounterParticipants"/>
	  	</Participants>
	</xsl:if>
  </xsl:template>
  ...
  <xsl:template match="*" mode="eE-encounter-HealthCareFacility">
    ...
    <!--
			...
			Also set the Encounter Locations.
		-->
    <xsl:choose>
      <xsl:when test="hl7:participant[@typeCode = 'LOC']/hl7:participantRole[@classCode = 'SDLOC']">
        <HealthCareFacility>
		  ...
		  <xsl:apply-templates select="hl7:participant[@typeCode = 'LOC']/hl7:participantRole[@classCode = 'SDLOC']/hl7:addr" mode="fn-T-pName-address"/>
		  <xsl:apply-templates select="hl7:participant[@typeCode = 'LOC']/hl7:participantRole[@classCode = 'SDLOC']" mode="fn-T-pName-ContactInfo"/>	
        </HealthCareFacility>
		<xsl:if test="count(hl7:participant[@typeCode='LOC']) > 0">
			<Locations>
				<xsl:apply-templates select="hl7:participant[@typeCode='LOC']/hl7:participantRole[@classCode = 'SDLOC']" mode="fn-ServiceDeliveryLocation"/>
			</Locations>
		</xsl:if>
      </xsl:when>
      <!--
  ...
  <xsl:template match="hl7:observation" mode="eE-Indication">
	<xsl:variable name="idRoot" select="hl7:id/@root"/>
	<xsl:variable name="idExtension" select="hl7:id/@extension"/>
	<xsl:choose>
		<xsl:when test="//hl7:observation[hl7:templateId/@root=$ccda-ProblemObservation and hl7:id/@root=$idRoot and hl7:id/@extension=$idExtension]">
			<AdmitReasonReference>
		...
		<xsl:otherwise>
			<xsl:apply-templates select="hl7:value" mode="fn-CodeTable">
				<xsl:with-param name="hsElementName" select="'AdmitReason'"/>
			</xsl:apply-templates>
		</xsl:otherwise>
	</xsl:choose>
  </xsl:template>

  <xsl:template match="hl7:statusCode" mode="eE-EncounterStatus">
	<xsl:if test="@code">
		<xsl:variable name="actStatusCode" select="@code"/>
		<Status>
			<SDACodingStandard>http://hl7.org/fhir/encounter-status</SDACodingStandard>
			<xsl:choose>
				<xsl:when test="$actStatusCode = 'aborted'">
					<Code>unknown</Code>
					<Description>Unknown</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'active'">
					<Code>in-progress</Code>
					<Description>In Progress</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'cancelled'">
					<Code>cancelled</Code>
					<Description>Cancelled</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'completed'">
					<Code>finished</Code>
					<Description>Finished</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'held'">
					<Code>planned</Code>
					<Description>Planned</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'new'">
					<Code>unknown</Code>
					<Description>Unknown</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'suspended'">
					<Code>On Leave</Code>
					<Description>Unknown</Description>
				</xsl:when>
				<xsl:when test="$actStatusCode = 'nullified'">
					<Code>entered-in-error</Code>
					<Description>Entered in Error</Description>
				</xsl:when>
				<xsl:otherwise>
					<Code>unknown</Code>
					<Description>Unknown</Description>
  ...
  <xsl:template name="eE-detailPart2">
    ...
    <xsl:if test="$sectionEntriesHF and $isNoDataSectionHF = '0' and $healthFundImportMode = '1'">
      <HealthFunds>
