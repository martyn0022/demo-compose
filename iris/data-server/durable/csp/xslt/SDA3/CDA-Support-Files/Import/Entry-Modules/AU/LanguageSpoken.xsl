...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="*" mode="LanguageSpoken">
		<!--
			...
			Target: HS.SDA3.Patient PrimaryLanguage
			Target: /Container/Patient/PrimaryLanguage
			Source: /ClinicalDocument/recordTarget/patientRole/patient/languageCommunication[preferenceInd/@value = 'true']/languageCode
		...
		<!--
			...
			Target: HS.SDA3.Patient OtherLanguages.PatientLanguage
			Target: /Container/Patient/OtherLanguages/PatientLanguage
			Source: /ClinicalDocument/recordTarget/patientRole/patient/languageCommunication[preferenceInd/@value != 'true']/languageCode
			StructuredMappingRef: CodeTableDetail
		-->
