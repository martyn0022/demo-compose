...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="hl7:act" mode="HealthPlan">
		...
		<xsl:choose>
			<xsl:when test="hl7:entryRelationship[@typeCode='COMP']/hl7:act/hl7:participant[@typeCode='COV']/hl7:time">
				<xsl:apply-templates select="hl7:entryRelationship[@typeCode='COMP']/hl7:act/hl7:participant[@typeCode='COV']/hl7:time/hl7:low[not(@nullFlavor)]" mode="FromTime"/>
				<xsl:apply-templates select="hl7:entryRelationship[@typeCode='COMP']/hl7:act/hl7:participant[@typeCode='COV']/hl7:time/hl7:high[not(@nullFlavor)]" mode="ToTime"/>
			</xsl:when>
			<xsl:otherwise>
		...
		<!-- Health Plan Details -->
		<xsl:apply-templates select="hl7:entryRelationship[@typeCode='COMP']/hl7:act[hl7:templateId/@root=$ccda-PolicyActivity]" mode="HealthPlanDetail">
	...
	<xsl:template match="*" mode="HealthPlanDetail">
		...
		<!-- Fund ID -->
		<xsl:if test="hl7:performer[hl7:templateId/@root=$ccda-PerformerPayer]/hl7:assignedEntity/hl7:id[1][not(@nullFlavor)]">
			<xsl:choose>
				<xsl:when test="$planMode = 'MemberEnrollment'">
					<HealthFund> <!-- uses full SDA object, not just the CodeTableDetail -->
						<xsl:apply-templates select="hl7:performer[hl7:templateId/@root=$ccda-PerformerPayer]/hl7:assignedEntity" mode="FundId"/>
					</HealthFund>
				</xsl:when>
				<xsl:otherwise>
						<xsl:apply-templates select="hl7:performer[hl7:templateId/@root=$ccda-PerformerPayer]/hl7:assignedEntity" mode="FundId"/>
		...
		<xsl:choose>
			<xsl:when test="hl7:entryRelationship[@typeCode='REFR']/hl7:act[@moodCode='DEF']/hl7:text">
				<xsl:apply-templates select="hl7:entryRelationship[@typeCode='REFR']" mode="PlanId-Authorization">
					<xsl:with-param name="planMode" select="$planMode"/>
				</xsl:apply-templates>
			</xsl:when>
			<xsl:when test="hl7:performer[hl7:templateId/@root=$ccda-PerformerPayer]/hl7:assignedEntity/hl7:id[1][not(@nullFlavor)]">
				<xsl:apply-templates select="hl7:performer[hl7:templateId/@root=$ccda-PerformerPayer]/hl7:assignedEntity/hl7:id[1][not(@nullFlavor)]" mode="PlanId-Performer">
					<xsl:with-param name="planMode" select="$planMode"/>
				</xsl:apply-templates>
			</xsl:when>
		</xsl:choose>
		...
		<xsl:if test="$planMode = 'MemberEnrollment'">
			...
			<xsl:if test="$guarantor/hl7:assignedEntity/hl7:id[not(@nullFlavor)]">
				<OtherPayors>
					<xsl:apply-templates select="$guarantor/hl7:assignedEntity[hl7:id[not(@nullFlavor)]]" mode="FundId"/>
				</OtherPayors>
			</xsl:if>
		</xsl:if>
		...
		<!--
			Field : Payer Member ID
			Target: HS.SDA3.MemberEnrollment MembershipNumber
			Target: /Container/Encounters/Encounter/MemberEnrollments/MemberEnrollment/MembershipNumber
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.18']/entry/act/entryRelationship/act/participant[@typeCode='COV']/participantRole/id/@extension
		-->
		<!--
			Field : Payer Subscriber ID
			Target: HS.SDA3.MemberEnrollment MembershipNumber
			Target: /Container/MemberEnrollments/MemberEnrollment/MembershipNumber
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.18']/entry/act/entryRelationship/act/participant[@typeCode='COV']/participantRole/id/@extension
		-->
	...
	<xsl:template match="*" mode="PlanId-Authorization">
		<xsl:param name="planMode" select="'HealthFund'"/>
		<!--
	...
	<xsl:template match="*" mode="PlanId-Performer">
		<xsl:param name="planMode" select="'HealthFund'"/>
		<!--
			Field : Payer Health Plan Insurance Information SourceId
			Target: HS.SDA3.HealthFund HealthFundPlan
	...
	<xsl:template match="*" mode="PolicyHolder">
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.18']/entry/act/entryRelationship/act/participant[@typeCode='HLD']/participantRole/playingEntity/name
		...
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.18']/entry/act/entryRelationship/act/participant[@typeCode='HLD']/participantRole/addr
			StructuredMappingRef: Address
		-->
		...
		<!--
			...
			Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.18']/entry/act/entryRelationship/act/participant[@typeCode='HLD']/participantRole
			StructuredMappingRef: ContactInfo
		-->
