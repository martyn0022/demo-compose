...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:hl7="urn:hl7-org:v3" exclude-result-prefixes="hl7">
	...
	<xsl:template match="hl7:procedure" mode="eP-Procedure">
		...
		<Procedure>
			...
			<!--
				Field : Procedure Date/Time
				Target: HS.SDA3.Procedure FromTime
				Target: /Container/Procedures/Procedure/FromTime
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/effectiveTime/low/@value
			-->
			<!--
				Field : Procedure Date/Time
				Target: HS.SDA3.Procedure ToTime
				Target: /Container/Procedures/Procedure/ToTime
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/effectiveTime/high/@value
			-->
			<xsl:choose>
				...
				<xsl:when test="hl7:effectiveTime/hl7:low/@value | hl7:effectiveTime/hl7:high/@value">
			...
			<!--
				...
				Note:  If /@negationInd="true”, then set status as “not-done”
			-->
			<xsl:choose>
				<xsl:when test="../hl7:procedure/@negationInd='false'">
					<Status>
						<Code>not-done</Code>
				...
				<xsl:otherwise>
					<xsl:apply-templates select="hl7:statusCode" mode="eP-ProcedureStatus"/>	
				</xsl:otherwise>
			</xsl:choose>

			<!--
				Field : Procedure BodySite
				Target: HS.SDA3.Procedure BodySite
 				Target: /Container/Procedures/Procedure/BodySite
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/targetSiteCode
			-->
			<xsl:if test="string-length(hl7:targetSiteCode/@code)">
				<BodySite>
					<xsl:apply-templates select="hl7:targetSiteCode" mode="fn-CodeTableDetail"/>
				</BodySite>
			</xsl:if>

			<!--
				Field : Procedure ProcedureReason
				Target: HS.SDA3.Procedure ProcedureReason
 				Target: /Container/Procedures/Procedure/ProcedureReason
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/entryRelationship[@typeCode='RSON']/observation/value
			-->
			<xsl:if test="string-length(hl7:entryRelationship[@typeCode='RSON']/hl7:observation/hl7:value/@code)">
				<ProcedureReason>
					...
					<SDACodingStandard><xsl:value-of select="hl7:entryRelationship[@typeCode='RSON']/hl7:observation/hl7:value/@codeSystemName" /></SDACodingStandard>
				</ProcedureReason>
			</xsl:if>

			<!--
				Field : Procedure Locations
				Target: HS.SDA3.Procedure Locations
 				Target: /Container/Procedures/Procedure/Locations
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/participant[@typeCode='LOC']/participantRole[@classCode = 'SDLOC']
			-->
			<xsl:if test="hl7:participant[@typeCode='LOC']/hl7:participantRole">
					<xsl:apply-templates select="hl7:participant[@typeCode='LOC']/hl7:participantRole[@classCode='SDLOC']" mode="fn-FacilityLocation"/>
			</xsl:if>

			<!--
				Field : Procedure ProcedureNotes
				Target: HS.SDA3.Procedure ProcedureNotes
 				Target: /Container/Procedures/Procedure/ProcedureNotes
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='2.16.840.1.113883.10.20.22.2.7.1']/entry/procedure/entryRelationship/act[code/@code='48767-8']/text
			-->
			<xsl:if test="hl7:entryRelationship/hl7:act[hl7:code/@code='48767-8']/hl7:text">
				<ProcedureNotes>
					<xsl:value-of select="hl7:entryRelationship/hl7:act[hl7:code/@code='48767-8']/hl7:text"/>
				</ProcedureNotes>
			</xsl:if>

			<!--
				There is no property on HS.SDA3.Procedure that may be used to
	...
	<xsl:template match="hl7:statusCode" mode="eP-ProcedureStatus">
		<xsl:if test="@code">
