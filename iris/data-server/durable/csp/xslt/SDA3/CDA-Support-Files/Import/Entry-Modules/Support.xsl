...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:isc="http://extension-functions.intersystems.com" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exsl="http://exslt.org/common" exclude-result-prefixes="isc hl7 xsi exsl">
	...
	<xsl:template match="*" mode="Support">
		...
		<xsl:if test="$patientGenderIdentityImportMode = '1'">
			<xsl:apply-templates select="$sectionRootPath[hl7:templateId/@root=$socialHistorySectionTemplateId]/hl7:entry/hl7:observation" mode="GenderIdentity"/>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="hl7:observation" mode="GenderIdentity">
		<!--
				...
				Source: /ClinicalDocument/component/structuredBody/component/section[templateId/@root='1.3.6.1.4.1.19376.1.5.3.1.3.16']/entry/observation
		-->
		<xsl:if test="hl7:code/@code='76691-5'">
